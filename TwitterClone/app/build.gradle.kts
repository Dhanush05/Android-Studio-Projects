...
android {
    namespace = "com.dhanush.twitterclone"
    compileSdk = 33

    defaultConfig {
        applicationId = "com.dhanush.twitterclone"
        minSdk = 21
        targetSdk = 33
        versionCode = 1
        versionName = "1.0"
...
dependencies {
    ...
    implementation("androidx.swiperefreshlayout:swiperefreshlayout:1.1.0") // Glide dependency
